...
const pages = ['Products', 'Shop', 'Blog'];
...
function Header() {
  ...
  return (
    <AppBar position="sticky" color={darkMode ? 'default' : 'primary'} sx={{ zIndex: 1200 }}>
      <Container maxWidth="xl">
        <Toolbar disableGutters>
          <AgricultureIcon sx={{ display: { xs: 'none', md: 'flex' }, mr: 1,fontSize:"40px" }}  />
          <Typography
            variant="h6"
            noWrap
            component="a"
